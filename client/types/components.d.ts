...
namespace ComponentTypes {
  ...
  export interface DataGridProps<TNew, TUpdate, TDelete> {
    ...
    newDataFunction: UseMutateAsyncFunction<GlobalTypes.BackendResponseParams, Error, TNew, unknown>;
    updateDataFunction: UseMutateAsyncFunction<GlobalTypes.BackendResponseParams, Error, TUpdate, unknown>;
    deleteDataFunction: UseMutateAsyncFunction<GlobalTypes.BackendResponseParams, Error, TDelete, unknown>;
  }
