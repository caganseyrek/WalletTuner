...
export namespace Transaction {
  ...
  export namespace Hook {
    export type CreateProps = Omit<Omit<TransactionPropsWithString, "_id">, "user_id">;
    export type UpdateProps = Omit<TransactionPropsWithString, "user_id">;
    export type DeleteProps = Pick<TransactionPropsWithString, "_id">;
  }
