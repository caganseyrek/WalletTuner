...
const STATUS_CODES: GlobalTypes.StatusCodeParams = {
  ...
  notAcceptable: { code: 406, message: "Request not acceptable" },
  requestTimeout: { code: 408, message: "Request timed out" },
  conflict: { code: 409, message: "Conflict with the current state of the resource" },
  gone: { code: 410, message: "Resource is no longer available" },
  lengthRequired: { code: 411, message: "Content-Length header is required" },
  preconditionFailed: { code: 412, message: "Precondition failed" },
  payloadTooLarge: { code: 413, message: "Payload is too large" },
  uriTooLong: { code: 414, message: "URI is too long" },
  ...
  tooManyRequests: { code: 429, message: "Too many requests, try again later" },
